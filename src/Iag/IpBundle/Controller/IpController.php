...
namespace Iag\IpBundle\Controller;
...
use Iag\IpBundle\Entity\Ip;
use Iag\IpBundle\Form\IpType;
...
class IpController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IagIpBundle:Ip')->findAll();
     ...
     * @Method("POST")
     * @Template("IagIpBundle:Ip:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IagIpBundle:Ip')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IagIpBundle:Ip:edit.html.twig")
     */
